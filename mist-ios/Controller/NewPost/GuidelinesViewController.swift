...
protocol GuidelinesDelegate {
    func closeButtonPressed()
}

class GuidelinesViewController: UIViewController, GuidelinesDelegate {
    ...
    func setupCollectionView() {
        ...
        collectionView.register(GuidelinesCollectionCell.self, forCellWithReuseIdentifier: String(describing: GuidelinesCollectionCell.self))
...
extension GuidelinesViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: String(describing: GuidelinesCollectionCell.self), for: indexPath) as! GuidelinesCollectionCell
