...
//Note: the indent on the top does NOT appear when the tableview is presented modally
...
class MapSearchViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        present(mySearchController, animated: false)
    }
}

extension MapSearchViewController: UISearchControllerDelegate {
    func setupSearchBar() {
