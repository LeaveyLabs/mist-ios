...
protocol FeedToggleViewDelegate {
    func labelDidTapped(index: Int)
}

class FeedToggleView: UIView {
    ...
    var labels: [UILabel] {
        return [labelOne, labelTwo, labelThree, labelFour]
    }
    ...
    //Constants
    let SELECTED_FONT = UIFont(name: Constants.Font.Heavy, size: 17)
    let DESELECTED_FONT = UIFont(name: Constants.Font.Roman, size: 17)
